function problem = sine_pipe_periodic(input_params)
...
% bottom wall            
% walls{2} = @(T) geometry_periodic_channel(@(t) -0.5+A*sin(pi*t+pi/2), ...
%     @(t) pi*A*cos(2*pi*t), @(t) -pi*pi*A*sin(pi*t),T,-1,problem.Lx);
