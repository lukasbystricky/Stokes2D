                ...
                { // Only panels not equal to -1 will be considered
                    ...
                    if (check_sq) {
                        ...
                        if (!accurate) {
                            ...
                            Ic16 = -(btar*imag(Ih1) + _i*conj(btar*(Ih2+Is1-conj(z)*Is2)))/pi;
                            sum16 = Ic16;
                            ...
                            if (accurate) {
                                ...
                                Ic32 = -(btar*imag(Ih1) + _i*conj(btar*(Ih2+Is1-conj(z)*Is2)))/pi;
                                sum32 = Ic32;
                                ...
                                Complex sq_prod = -(btar*imag(Ih1) + _i*conj(btar*(Ih2+Is1-conj(z)*Is2)))/pi;
