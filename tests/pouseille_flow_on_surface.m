...
grid on;
title('on-surface velocity gradient');
legend('Ux','Uy','Vx','Vy');
ylabel('error');
xlabel('n');
xlim([1,N]);
...
grid on;
title('on-surface pressure gradient');
legend('Px','Py');
ylabel('error');
xlabel('n');
xlim([1,N]);
...
legend('Sxx','Sxy','Syx','Syy');
grid on;
title('on-surface stress');
ylabel('error');
xlabel('n');
xlim([1,N]);
